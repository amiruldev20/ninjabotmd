...
//# SEND MESSAGE
public send = async (mel: Proto | string, content: Content): Promise<baileys.proto.WebMessageInfo> => {
try {
...
typeof mel === 'object' ? mel.key.remoteJid! : mel,
...
//# COPY N FORWARD 
/*
public copynfwd = async (mel: Proto, text: string, forwardingScore: boolean, content: Content): Promise<baileys.proto.WebMessageInfo> => {
let m = baileys.generateForwardMessageContent(text, !!forwardingScore)
let mtype = Object.keys(m)[0]
if (forwardingScore && typeof forwardingScore == 'number' && forwardingScore > 1) m[mtype].contextInfo.forwardingScore += forwardingScore
 m = baileys.generateWAMessageFromContent(typeof mel === 'object' ? mel.key.remoteJid! : mel, m, { ...options, userJid: conn.user.id })
await conn.relayMessage(jid, m.message, { messageId: m.key.id, additionalAttributes: { ...options } })
return m
}
*/

public sendButton = async (mel: Proto, content: Content, buttons: ButtonConfig[]): Promise<baileys.proto.WebMessageInfo> => {
try {
...
public throw = async (mel: Proto, error: any, cmd: string): Promise<baileys.proto.WebMessageInfo> => {
await this.send(set.numown[0] + '@s.whatsapp.net', {
text: `Error\nCommand: ${cmd}\n\n${error}`,
});
return client.reply(mel, set.resp.error);
};

downloadMessage = async (mel: Proto, filename?: string) => {
try {
const values = Object.values(this.messageType);
const type = Object.keys(mel).find((a) => values.includes(a) && !a.includes('senderKey') && !a.includes('context'));
return this.getBuffer(
await this.baileys.downloadContentFromMessage(
mel[type as keyof Proto] as baileys.DownloadableMessage,
...
public metadata = (mel: baileys.proto.IWebMessageInfo): Promise<Proto> => {
async function fallback(mel: baileys.proto.IWebMessageInfo) {
const proto: Proto = {} as Proto;
proto.type = [
Object.keys(mel.message!)[0],
Object.keys(mel.message!).find((a) => {
...
//-- PROTO BAILEYS
proto.baileys = mel.key?.id ? mel.key?.id.length === 16 || mel.key.id.startsWith("3EB0") : false

//-- PROTO MESSAGE
proto.message = proto.type[1] === 'ephemeralMessage' ? mel.message?.ephemeralMessage?.message : mel.message;

//-- PROTO DATA
proto.data =
typeof mel.message![proto.type[1] as keyof baileys.proto.IMessage] === 'object'
? Object.keys(mel.message![proto.type[1] as keyof baileys.proto.IMessage]!).includes('contextInfo')
? Object.keys(mel.message![proto.type[1] as keyof baileys.proto.IMessage]!).concat(
Object.keys((mel.message![proto.type[1] as keyof baileys.proto.IMessage]! as Record<string, any>).contextInfo),
)
: Object.keys(mel.message![proto.type[1] as keyof baileys.proto.IMessage]!)
: Object.keys(mel.message!);

//-- PROTO STRING
proto.string =
proto.type[1] === 'conversation'
? mel.message?.conversation
: proto.data.includes('caption')
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage]!.caption
: proto.type[1] === 'extendedTextMessage'
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].text
: proto.type[1] === 'templateButtonReplyMessage'
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].selectedId
: proto.type[1] === 'listResponseMessage'
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].singleSelectReply.selectedRowId
:  proto.type[1] === 'buttonsResponseMessage'
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].selectedButtonId : '';

//-- PROTO BODY
proto.body = mel.message![proto.type[1] as keyof baileys.proto.IMessage];

//-- PROTO VIEW
proto.view = proto.body ? proto.body : mel.message![proto.type[1] as keyof baileys.proto.IMessage];

proto.from = mel.key.remoteJid;
...
proto.sender = {
name: mel.pushName,
jid: proto.validator.isGroup ? (mel.key.participant ? mel.key.participant : client.socket.user.id) : mel.key.remoteJid,
};
proto.validator.isOwner =
set.numown.includes(proto.sender.jid ? proto.sender.jid.split('@')[0].split(':')[0] : '') || (mel.key.fromMe ?? false);
proto.client = {
...
? (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].contextInfo.mentionedJid
: undefined;
...
fromMe:
(mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].contextInfo
.participant === client.socket.user.id,
id: (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].contextInfo.stanzaId,
participant: (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].contextInfo.participant,
//participant: (mel.key.participant : client.socket.user.id) : mel.key.remoteJid,
//baileys: (mel.key.id && mel.key.id.length === 16 || mel.key.id.startsWith("3EB0") && mel.key.id.length === 12 || false as baileys.proto.IMessage),
},
message: (mel.message as Record<keyof baileys.proto.IMessage, any>)[proto.type[1] as keyof baileys.proto.IMessage].contextInfo
.quotedMessage,
} as {
...
proto.gcData = proto.validator.isGroup ? (await client.socket.groupMetadata(mel.key.remoteJid!)) : false;
...
? (((client.chats as Record<string, object>)[mel.key.remoteJid!] &&
(client.chats as Record<string, { messages: Record<string, object> }>)[mel.key.remoteJid!].messages[
